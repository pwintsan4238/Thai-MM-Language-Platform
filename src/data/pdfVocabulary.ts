...
export const pdfVocabulary: { [lessonId: number]: WordBreakdown[] } = {
  101: [
    { thai: "ภาษา", phonetic: "pha-sa", english: "Language", myanmar: "ဘာသာစကား", partOfSpeech: "noun" },
    { thai: "ไวยากรณ์", phonetic: "wai-ya-korn", english: "Grammar", myanmar: "သဒ္ဒါ", partOfSpeech: "noun" },
    { thai: "เรียน", phonetic: "rian", english: "To study / learn", myanmar: "လေ့လာသည် / သင်ယူသည်", partOfSpeech: "verb" },
    { thai: "เข้าใจ", phonetic: "khao-chai", english: "To understand", myanmar: "နားလည်သည်", partOfSpeech: "verb" },
    { thai: "หนังสือ", phonetic: "nang-sue", english: "Book", myanmar: "စာအုပ်", partOfSpeech: "noun" },
    { thai: "พูด", phonetic: "phut", english: "To speak", myanmar: "ပြောသည်", partOfSpeech: "verb" },
    { thai: "เขียน", phonetic: "khian", english: "To write", myanmar: "ရေးသည်", partOfSpeech: "verb" },
    { thai: "ง่าย", phonetic: "ngai", english: "Easy", myanmar: "လွယ်ကူသော", partOfSpeech: "adjective" },
    { thai: "ยาก", phonetic: "yak", english: "Difficult", myanmar: "ခက်ခဲသော", partOfSpeech: "adjective" },
    { thai: "ฝึกฝน", phonetic: "phuek-fon", english: "To practice", myanmar: "လေ့ကျင့်သည်", partOfSpeech: "verb" }
  ],
  1: [
